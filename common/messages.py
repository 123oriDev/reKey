"""common/messages.py — canonical protocol helpers.

Superset of server/util.py (52 lines) + client/mobile/util.py (67 lines).
Server/cli use generate_message/decode_message; mobile also uses send_message.
Original duplicates: server/util.py, client/cli_client/util.py, client/mobile/util.py
"""
