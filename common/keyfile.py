"""common/keyfile.py — canonical FileKeyReader.

Identical copies were at client/cli_client/run_key_file.py and client/mobile/run_key_file.py
"""
...
def main():
    ...
    FileReader = FileKeyReader(
        handler=FileKey, path=r"C:\Users\Ori\Documents\apps\reKey\tests\try.txt"
    )
    FileReader.start()
